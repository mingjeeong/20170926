...
public class EmployeeService {
	 ...
	 * @return
	 */
	public int join(String eId,String ePw,String eKname,String e_efname, String eElname,String eSex,String eBirth,String eMobile,String eEmail) {
		return dao.join(eId, ePw, eKname, e_efname, eElname, eSex, eBirth, eMobile, eEmail);
	}
