...
<table width="1340" height="650" border="1">
  ...
  <tr>
   <td width="80%" height="70%">
   		<table align="center" >
			<tr>
				<td><a href="#"><img src="images/e_issue.jpg" width="100" height="50"></a></td>
				<td>&nbsp;</td>
				<td><a href="SearchTicket.jsp"><img src="images/e_check.jpg" width="100" height="50"></a></td>
			</tr>
			<tr><td>&nbsp;</td></tr>
			<tr>
				<td><a href="Controller?action=#"><img src="images/e_cancel.jpg" width="100" height="50"></a></td>
				<td>&nbsp;</td>
				<td><a href="SearchTicket.jsp"><img src="images/e_book.jpg" width="100" height="50"></a></td>
			</tr>
		</table>
   </td>
  </tr>
